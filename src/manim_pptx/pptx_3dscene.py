...
class PPTX_ThreeDScene(ThreeDScene):
    ...
    def render(self, *args, **kwargs):
        ...
        prs = pptx.Presentation(
            pptx=os.path.join(os.path.split(__file__)[0], "template.pptx")
        )
        ...
        for tslidei, tslide in enumerate(self.slides):
            slide_movie_files = self.renderer.file_writer.partial_movie_files[
                tslide["start"] : tslide["end"]
            ]
            ...
            if tslide["shownextnotes"] and len(self.slides) > tslidei + 1:
                notes += "\n" + "\n".join(
                    list(
                        map(
                            lambda x: "> " + x,
                            self.slides[tslidei + 1]["notes"].split("\n"),
                        )
                    )
                )
            ...
            for src_file in slide_movie_files:
                thumb_file = os.path.join(
                    self.temporary_dir, os.path.basename(src_file) + ".png"
                )
                self.save_video_thumb(src_file, thumb_file)

                clip = slide.shapes.add_movie(
                    src_file,
                    0,
                    0,
                    prs.slide_width,
            ...
            if len(pics) > 0:
                ...
                def addCTn():
                    innercTn = etree.Element(
                        "{http://schemas.openxmlformats.org/presentationml/2006/main}cTn",
                        id=str(getcTnIDCounter()),
                        dur="indefinite",
                        nodeType="mainSeq",
                    )
                    childTnLst = etree.Element(
                    ...
                    if tslide["type"] == "loop":
                        cTn.attrib["dur"] = str(
                            reduce(lambda x, y: x + y, [p["dur"] for p in pics])
                        )
                        cTn.attrib["repeatCount"] = "indefinite"
                    stCondLst = etree.Element(
                    ...
                    cond2tn = etree.Element(
                        "{http://schemas.openxmlformats.org/presentationml/2006/main}tn",
                        val="2",
                    )
                ...
                def addPrevCondLst():
                    prevCondLst = etree.Element(
                        "{http://schemas.openxmlformats.org/presentationml/2006/main}prevCondLst"
                    )
                    cond = etree.Element(
                        "{http://schemas.openxmlformats.org/presentationml/2006/main}cond",
                        evt="onPrev",
                ...
                def addNextCondLst():
                    nextCondLst = etree.Element(
                        "{http://schemas.openxmlformats.org/presentationml/2006/main}nextCondLst"
                    )
                    cond = etree.Element(
                        "{http://schemas.openxmlformats.org/presentationml/2006/main}cond",
                        evt="onNext",
                ...
                for i, pic in enumerate(pics):
                    ...
                    def addToFrontEffect():
                        ...
                        cond = etree.Element(
                            "{http://schemas.openxmlformats.org/presentationml/2006/main}cond",
                            delay=str(currentdelay),
                        )
                        stCondLst.append(cond)
                        cTn.append(stCondLst)

                        innerchildTnLst = etree.Element(
                            "{http://schemas.openxmlformats.org/presentationml/2006/main}childTnLst"
                        )
                        innerPar = etree.Element(
                            "{http://schemas.openxmlformats.org/presentationml/2006/main}par"
                        )
                        innercTn = etree.Element(
                            "{http://schemas.openxmlformats.org/presentationml/2006/main}cTn",
                            ...
                            presetSubtype="0",
                            fill="hold",
                            nodeType="withEffect" if i == 0 else "afterEffect",
                        )
                        innerstCondLst = etree.Element(
                            "{http://schemas.openxmlformats.org/presentationml/2006/main}stCondLst"
                        )
                        innercond = etree.Element(
                            "{http://schemas.openxmlformats.org/presentationml/2006/main}cond",
                            delay="0",
                        )
                        ...
                        innerInnerChildTnLst = etree.Element(
                            "{http://schemas.openxmlformats.org/presentationml/2006/main}childTnLst"
                        )
                        ...
                        cBhvrcTn = etree.Element(
                            "{http://schemas.openxmlformats.org/presentationml/2006/main}cTn",
                            id=str(getcTnIDCounter()),
                            dur="1",
                            fill="hold",
                        )
                        cBhvrcTnstCondLst = etree.Element(
                            "{http://schemas.openxmlformats.org/presentationml/2006/main}stCondLst"
                        )
                        cBhvrcTncond = etree.Element(
                            "{http://schemas.openxmlformats.org/presentationml/2006/main}cond",
                            delay="0",
                        )
                    ...
                    def addToBackEffect():
                        ...
                        cmd = etree.Element(
                            "{http://schemas.openxmlformats.org/presentationml/2006/main}cmd",
                            type="call",
                            cmd="stop",
                        )
                        cBhvr = etree.Element(
                        ...
                        cBhvrcTnstCondLstCond = etree.Element(
                            "{http://schemas.openxmlformats.org/presentationml/2006/main}cond",
                            delay="0",
                        )
